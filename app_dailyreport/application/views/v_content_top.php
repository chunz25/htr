		...
		<ul class="nav navbar-nav navbar-right">
			<li class="">
				...
				<ul class="dropdown-menu dropdown-usermenu pull-right">
					<li><a href="<?php echo site_url(''); ?>/pengajuan/changePassword"><i
								class="fa fa-pencil pull-right"></i> Ubah Password</a></li>
					<li><a href="<?php echo config_item('url_logout'); ?>/logout"><i
								class="fa fa-sign-out pull-right"></i> Log Out</a></li>
				</ul>
			</li>

			<li role="presentation" class="dropdown">
				<a id="id_btnnotif" href="javascript;" class="dropdown-toggle info-number" data-toggle="dropdown"
					aria-expanded="false">
			...
			<?php if (
				($this->session->userdata('username') == '15080236')
			) {
				?>
				<li class="">
			...
			<?php if (
				($this->session->userdata('username') == '13121215') ||
				($this->session->userdata('username') == '1694') ||
				($this->session->userdata('username') == '15080236')
			) {
				?>
				<li class="">
