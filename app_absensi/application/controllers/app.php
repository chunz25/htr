...
class app extends ABSENSI_Controller
{
	...
	private function default_create()
	{
		$data['config'] = array(
			...
			'view_absensi' => config_item('view_absensi'),
			'tombol' => config_item('tombol'),
			'userid' => $this->session->userdata('userid'),
			'username' => $this->session->userdata('username'),
			'nama' => $this->session->userdata('nama'),
			'usergroup' => $this->session->userdata('akses_absensi'),
			'no_image_person_url' => config_item('no_image_person_url'),
			'absensi_upload_url_foto' => config_item('absensi_upload_foto_url'),
