Ext.define("ABSENSI.components.window.WinAllPegawai",{
	extend : "ABSENSI.components.window.WinButtons",
	alias : 'widget.winallpegawai',	
	requires:[
		'ABSENSI.abstract.SearchField',
		'ABSENSI.components.grid.Pegawai'
	],	
	config: {
		jabatanid: '',
	},	
	...
	buildContent:function(){
		var me=this;		
		return Ext.create('ABSENSI.components.grid.Pegawai', {
			border: false
		});
	},	
	onPilih:function(){
