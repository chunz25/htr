Ext.define('ABSENSI.components.tree.UnitKerja', {
    extend: 'Ext.tree.Panel',
    alternateClassName: 'ABSENSI.unitkerja',
    alias: 'widget.unitkerja',
    rootTitle: 'Unit Kerja',
    onlySatker: true,
    initComponent: function () {
        ...
        var store = Ext.create('Ext.data.TreeStore', {
            ...
            fields: ['id', 'text', 'direktorat', 'divisi', 'departemen', 'seksi', 'subseksi', 'kepalanama'],
            root: {
                text: me.rootTitle,
                id: '0',
                expanded: false,
