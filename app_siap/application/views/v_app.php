...
<head>
	...
	<script type="text/javascript">
		...
		if (Settings.userid == false) {
			...
			if (Settings.userid == '1' || Settings.userid == '5' || Settings.userid == '37' || Settings.userid == '1216' || Settings.userid == '1694' || Settings.userid == '192') {
				first_menu = 'dailyreport';
			} else {}
		}
		...
		Ext.onReady(function() {
			...
			if (Settings.userid == '192') {
				var haldailyreport = '<li><a href="#dailyreport">Daily Report</a></li>';
				var halpegawai = '';
				var haltambah = '';
				var halreportcount = '';
				var halreportsum = '';
				var logo = '<div class="logoleft"><a href="' + Settings.BASE_URL + '"><img src="' + Settings.BASE_URL + 'setting/eci/old_logo.png' + '"></a></div>';
			} else if (Settings.username == 'dev') {
				var haldailyreport = '<li><a href="#dailyreport">Daily Report</a></li>';
				var halpegawai = '';
				var haltambah = '';
				var halreportcount = '';
				var halreportsum = '';
				var logo = '<div class="logoleft"><img src="' + Settings.BASE_URL + 'setting/eci/old_logo.png' + '"></a></div>';
			} else {
				var haldailyreport = '<li><a href="#dailyreport">Daily Report</a></li>';
				var halpegawai = '<li><a href="#pegawai">Data Pegawai</a></li>';
				var haltambah = '<li><a href="#tambahpegawai">Tambah Pegawai</a></li>';
				var halreportcount = '<li><a href="#countreport">Summary Report</a></li>';
				var halreportsum = '<li><a href="#sumreport">Summary Report v2</a></li>';
				var logo = '<div class="logoleft"><a href="' + Settings.BASE_URL + '"><img src="' + Settings.BASE_URL + 'setting/eci/old_logo.png' + '"></a></div>';
			}
